...
<body>
    ...
    <section class="forms-container">
        <div class="form-box blue-form">
            <h3 class="form-title">CEK TARIF</h3>
            <div class="input-group">
                <input type="text" placeholder="Tanjungpinang">
                <input type="text" placeholder="Kota Tujuan">
            </div>
            <button class="search-btn"><i class="fas fa-search"></i> SEARCH</button>
        </div>
        <div class="form-box white-form">
            <h3 class="form-title">CEK STATUS</h3>
            <input type="text" placeholder="LA-XXXXXXXX">
            <button class="check-btn"><i class="fas fa-paper-plane"></i> CHECK</button>
        </div>
    </section>
